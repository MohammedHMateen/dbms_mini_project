<?php
    ...
    $conn = new mysqli ("localhost", "root", "p", "mp_1");
    // Error if database can't be accessed
    if (mysqli_connect_error()){
        die('Connect Error ('. mysqli_connect_errno() .') '. mysqli_connect_error());
        }
    // Successful Connections then Insert the data to the Money Donations table
    else{
        ...
        if ($conn->query($sql)){
            ...
            echo "Error: ". $sql ."
            ". $conn->error;}
        // Close the access after inserting
        $conn->close();
        }
?>
...
<body>
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                <div class="row form-group">
                    <div class="col-12 col-xl-12 mb-4 mb-lg-0">
                        <h1 id="donations" class="h2">Add Money Donations Form</h1>
                        <form class="needs-validation" novalidate>
                            ...
                            <div class="form-group">
                                <label for="eveid">Amount</label>
                                <input type="number" class="form-control" name="Event_id" id="eveid"
                                    placeholder="Enter rupees donated" required>
                                <div class="invalid-feedback">Please provide a valid value.</div>
                                <div class="valid-feedback">Looks good!</div>
                            </div>
                            <fieldset class="form-group">
    <legend class="col-form-label pt-0">Received Status</legend>
    ...
    <small class="form-text text-muted">Deposit or Withdrawal ?</small>
                            ...
                            <button type="submit" value="SUBMIT" class="btn btn-primary">Add Money Donations !!</button>
                        ...
                        <!-- <div class="formz">
                            <form method="post" action="mdoadd.php">
                                ...
                                Received_status (Received/Pending/Cancelled): <input type="text"
                                    name="Rcv_stats"><br><br>
